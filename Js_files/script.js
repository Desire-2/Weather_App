function getCity(){
    ...
    function getUrl(){
        if(getCity()==0)
        return 'https://api.weatherapi.com/v1/current.json?key=cdc23c2bfa704dd5bc671756232708&q=all'
        else  
        return `https://api.weatherapi.com/v1/current.json?key=cdc23c2bfa704dd5bc671756232708&q=${getCity()}`
    }
    ...
    async function displayCityData(){
      ...
      paragraph=`
       <b> Name of City:</b> ${nm}<br>
       <b> Name of The Country:</b> ${country}<br>
